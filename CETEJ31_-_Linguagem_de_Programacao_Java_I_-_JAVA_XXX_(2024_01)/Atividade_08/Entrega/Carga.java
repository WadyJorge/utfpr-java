public final class Carga extends Veiculo implements Calcular {
    ...
    // Construtor para inicializar um objeto da classe Carga com todos os atributos
    public Carga(int cargaMax, int tara, String placa, String marca, String modelo, String cor, int velocMax, int qtdRodas, int qtdPist, int potencia) {
    ...
    public int setVelocMaxCarga(int velocMax) throws VelocException {
