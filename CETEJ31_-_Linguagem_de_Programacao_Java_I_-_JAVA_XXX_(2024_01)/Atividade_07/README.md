...
**Atenção:**
- O método calcVel(float velocMax) **NÃO** deve alterar o valor do atributo velocMax, <Strong>apenas convertê-lo</Strong> e retornar o valor convertido para que seja exibido na tela por meio da classe Teste;
</pre>
